                ...
                <div class="col-sm-10 offset-sm-1">
                  ...
                  <br>
                    ...
                    <form method="post" action="includes/login.inc.php" class="form-inline justify-content-center">
                        ...
                        <input type="submit" class="btn btn-primary btn-lg mr-1" name="login-submit" value="Login">
                    </form>
                    <br><a href="signup.php" class="btn btn-danger btn-lg mr-1">Signup</a>
                    ...
                    <div class="position-absolute login-icons">
                        ...
                        <a href="contact.php">
                            <i class="fa fa-cloud fa-2x social-icon" aria-hidden="true"></i>
                        </a>
                    </div>
