<?php
    ...
    define('TITLE',"Profile | Clicktalk");
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-8 text-center" id="user-section">
              <img class="cover-img" src="img/profile1.png">
                        ...
                        else
                        {
                            do
                            {
                                    echo '<div class="col-sm-4" style="padding-bottom: 30px;">
                                        <div class="card user-ideas">
                                            <a href="idea-page.php?id='.$row['idea_id'].'">
                                            <img class="card-img-top" src="uploads/'.$row['idea_img'].'" alt="Card image cap">
                                            <div class="card-block p-2">
                                              <p class="card-title">'.ucwords($row['idea_title']).'</p>
                                             <p class="card-text"><small class="text-muted">'
                                             .date("F jS, Y", strtotime($row['idea_date'])).'</small></p>
                                            </div>
                                            </a>
                                          </div>
                                          </div>';
