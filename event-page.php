        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-9" id="user-section">
                    ...
                    <img class="idea-cover" src="uploads/<?php echo $row['event_image']; ?>">
                    ...
                    <div class="px-5">
                        <div class="text-center px-5">
                            ...
                            <br><br>
                            <p class="text-muted text-left">requsted by: <?php echo ucwords($row['uidUsers']); ?></p>
