<?php
    ...
    define('TITLE',"Categories | ClickTalk");
    ...
    <body style="background: #f1f1f1">
      ...
      <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
        ...
        <div class="lh-100">
          ...
          <small>We Control the click you use the talk</small>
        </div>
      </div>
      ...
      <a href="forum.php"><input type="submit" class="btn btn-dark btn-lg" name="" value="Back"></a> 
    </main>
