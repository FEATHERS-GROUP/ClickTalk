                ...
                <div class="row">
                    ...
                    <div class="col-sm-7" >
                        ...
                        <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                              <a class="nav-link" id="idea-tab" data-toggle="tab" href="#idea" role="tab"
                                 aria-controls="idea" aria-selected="false">Recent ideas</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content" id="myTabContent">
                                        ...
                                        else
                                        {
                                            ...
                                            while ($row = mysqli_fetch_assoc($result))
                                            {
                                                echo '<div class="col-md-6">
                                                        ...
                                                        <img class="card-img-left flex-auto d-none d-lg-block ideaindex-cover"
                            ...
                            <div class="tab-pane fade" id="idea" role="idea" aria-labelledby="idea-tab">

                                <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
                                  <div class="lh-100">
                                    <h1 class="mb-0 text-white lh-100">Latest ideas</h1>
                                  </div>
                                </div>
                    ...
                    <div class="col-sm-2">
                        ...
                        <div class="text-center p-3 mt-5">
                            <a href="team.php" target="_blank">
                                <i class="creater-icon fa fa-file fa-5x" aria-hidden="true"></i>
                            </a>
                            <p><br>THE BOX</p>
                        </div>

                        <a href="forum.php" class="btn btn-warning btn-lg btn-block">clicktalk Forum</a>
                        <a href="hub.php" class="btn btn-secondary btn-lg btn-block">clicktalk Hub</a>
                        <br><br><br>
                        <a href="create-topic.php" class="btn btn-warning btn-lg btn-block">Create a Forum</a>
                        <a href="create-idea.php" class="btn btn-secondary btn-lg btn-block">Create a idea</a>
