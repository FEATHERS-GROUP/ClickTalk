<?php
    ...
    define('TITLE',"Edit Profile | ClickTalk");
    ...
    <?php include 'includes/navbar.php'; ?>
      <div class="container">
        ...
        <div class="col-sm-8 text-center" id="user-section">
              ...
              <img class="cover-img" id='blah-cover' src="img/profile1.png">
              ...
              <form action="includes/profileUpdate.inc.php" method='post' enctype="multipart/form-data"
                    ...
                    <div class="form-row">
                      <div class="col">
                        <input type="text" class="form-control" name="f-name" placeholder="Fullname"
                               value="<?php echo $_SESSION['f_name'] ?>" >
                        <small id="emailHelp" class="form-text text-muted">Full Name</small>
                      </div>
                      <div class="col">
                        <input type="text" class="form-control" name="l-name" placeholder="$companyName"
                               value="<?php echo $_SESSION['l_name'] ?>" >
                        <small id="emailHelp" class="form-text text-muted">Company Name</small>
                      </div>
                    </div>
                  ...
                  <hr>
                    ...
                    <div class="form-group">
                        <label for="headline">Profile Department</label>
                        <input class="form-control" type="text" id="headline" name="headline"
                               placeholder="Your Profile Department" value='<?php echo $_SESSION['headline']; ?>'><br>
