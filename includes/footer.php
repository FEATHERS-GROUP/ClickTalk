            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    ...
                    <ul>
                        ...
                        <li><a href="forum.php">The clicktalk Forum</a></li>
                        <li><a href="hub.php">The clicktalk Hub</a></li>
                    </ul>
                </div>
                <div class="col-sm-2">
                    <h5>About us</h5>
                    <ul>
                        <li><a href="_clicktalk creators/clicktalk_saad.php">Niyindagiye Abel</a></li>
                    </ul>
                </div>
                <div class="col-sm-2">
                    <h5>Support</h5>
