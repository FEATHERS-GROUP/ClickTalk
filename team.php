<?php
    ...
    define('TITLE',"The Team | clicktalk");
...
?>
    ...
    <body style="background: #f1f1f1">
        ...
        <div class="jumbotron text-white" style="background-image: url('img/team-cover.png')">
            <div class="container">
              <h1 class="display-3">The clicktalk Creators</h1>
              <h4>The Brains and Brawns behind all this</h4>
              <h1><a href="https://github.com/msaad1999/clicktalk--PHP-coded-Social-Media-Website">
        ...
        <section class="content-section" id="portfolio">
          ...
          <div class="container">
            ...
            <div class="content-section-heading text-center">
              <h3 class="text-secondary mb-0">The Minds Behind clicktalk</h3>
              <h2 class="mb-5">The Team</h2>
            </div>
            <div class="row no-gutters">
              <div class="col-lg-6">
                  <a class="portfolio-item" href="_clicktalk creators/clicktalk_saad.php" target="_blank">
                  <span class="caption">
              ...
              <div class="col-lg-6">
                <a class="portfolio-item" href="_clicktalk creators/clicktalk_anas-kamal.php" target="_blank">
                  <span class="caption">
                    <span class="caption-content">
              ...
              <div class="col-lg-6">
                <a class="portfolio-item" href="_clicktalk creators/clicktalk_ubaid.php" target="_blank">
                  <span class="caption">
                    <span class="caption-content">
              ...
              <div class="col-lg-6">
                <a class="portfolio-item" href="_clicktalk creators/clicktalk_anas-imran.php" target="_blank">
                  <span class="caption">
                    <span class="caption-content">
